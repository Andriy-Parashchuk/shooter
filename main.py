        ...
        if self.reload:
            ...
            if current_time - self.start_reload >= 1.5:
                ...
                for i in range(player.clip):
                    ammo = GameSprite("images/bullet.png", ammo_x, HEIGHT - HEIGHT // 9, HEIGHT // 20, HEIGHT // 12, 0)
...
class Enemy(GameSprite):
    def __init__(self):
        super().__init__("images/ufo.png", randint(0, WIDTH - HEIGHT // 5), randint(-HEIGHT, -HEIGHT // 7),
                         HEIGHT // 5, HEIGHT // 8, HEIGHT // 300)
...
class UfoBoss(GameSprite):
    def __init__(self):
        self.hp = 7
        super().__init__("images/ufo.png", randint(0, WIDTH - HEIGHT // 5), -HEIGHT // 4,
                         HEIGHT // 2.5, HEIGHT // 4, HEIGHT // 500)
...
class Bullet(GameSprite):
    def __init__(self, x, y):
        super().__init__("images/bullet.png", x, y, HEIGHT // 25, HEIGHT // 15, HEIGHT // 50)
...
class Asteroid(GameSprite):
    def __init__(self):
        ...
        super().__init__("images/asteroid.png", randint(0, WIDTH - HEIGHT // 6), randint(-HEIGHT, -HEIGHT // 7),
                         self.size, self.size, HEIGHT // 150)
...
for i in range(player.hp):
    heart = GameSprite("images/health.png", heart_x, HEIGHT // 15, HEIGHT // 14, HEIGHT // 14, 0)
    heart_x -= HEIGHT // 12
    health.append(heart)
